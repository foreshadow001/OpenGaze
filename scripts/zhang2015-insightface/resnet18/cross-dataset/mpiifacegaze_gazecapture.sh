...
# 用法: REUSE_EXP=expNN bash scripts/zhang2015-insightface/resnet18/cross-dataset/mpiifacegaze_gazecapture.sh
set -euo pipefail
source "$(dirname "$0")/../../../common.sh"

exp=$(require_exp zhang2015-insightface/mpiifacegaze resnet18)
"$PYTHON" main.py --dataset zhang2015-insightface/gazecapture --method resnet18 --test --exp "$exp" --run all
