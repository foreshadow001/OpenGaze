...
# 训练先完成，如: python main.py --dataset zhang2015-insightface/xgaze --method resnet18
# 用法: XGAZE_EXP=exp00 MPIIFACEGAZE_EXP=exp03 bash scripts/zhang2015-insightface/resnet18/cross-dataset/all.sh
set -uo pipefail
