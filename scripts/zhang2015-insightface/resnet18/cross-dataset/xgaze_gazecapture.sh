#!/usr/bin/env bash
# resnet18 / cross-dataset: 用 xgaze 上训练的模型（expNN）在 gazecapture 上测试
# 训练先完成: python main.py --dataset zhang2015-insightface/xgaze --method resnet18
# 用法: REUSE_EXP=expNN bash scripts/zhang2015-insightface/resnet18/cross-dataset/xgaze_gazecapture.sh
set -euo pipefail
